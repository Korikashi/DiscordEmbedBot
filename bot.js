...
const { handleUrlTiktok } = require('./commands/urlHandlerTiktok');
const { handleUrlInstagram } = require('./commands/urlHandlerInstagram');
...
client.once('ready', () => {
 ...
 // pasa los eventos a la funcion modular
client.on('messageCreate', handleUrlInstagram);
client.on('messageCreate', handleUrlTiktok);
